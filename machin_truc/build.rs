...
fn main() {
    ...
    let a = definition.add_datum::<u32, _>("datum_a");
    let _b = definition.add_datum::<u32, _>("datum_b");
    definition.close_record_variant();

    let _c = definition.add_datum::<u32, _>("datum_c");
    definition.close_record_variant();

    definition.remove_datum(a);
    definition.close_record_variant();

    let _d = definition.add_datum::<u8, _>("datum_d");
    let _e = definition.add_datum::<u16, _>("datum_e");
    let _f = definition.add_datum::<u32, _>("datum_f");
    definition.close_record_variant();
